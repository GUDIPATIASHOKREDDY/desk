...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    open func initView() {
       ...
       // imageView  = UIImageView(frame:CGRect(x: (opacityframe.origin.x)/2 + 280, y:opacityframe.origin.y + 20, width:50, height:50));
       // imageView.backgroundColor = UIColor.red
       // imageView.image = UIImage(named:"200px-KFC_logo.svg")
        //self.opacityView.addSubview(imageView)
...
//            statusBar.backgroundColor = UIColor(displayP3Red: 54.0/255.0, green: 208.0/255.0, blue: 181.0/255.0, alpha: 1)
//        }
    ...
    open override func openLeft() {
        guard let _ = leftViewController else { // If leftViewController is nil, then returnThread 1 Queue : com.apple.main-thread (serial)
    ...
    @objc func handleRightPanGesture(_ panGesture: UIPanGestureRecognizer) {
        ...
        case UIGestureRecognizer.State.ended, UIGestureRecognizerState.cancelled:
        ...
        case UIGestureRecognizer.State.failed, UIGestureRecognizerState.possible:
            break
        }
